...
// Vercel's Neon integration injects DATABASE_URL. POSTGRES_URL is what the
// older Vercel Postgres integration used — accept either so the wiring works
// whichever way the integration is connected.
